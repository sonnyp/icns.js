...
function getModernImageForSize (buf, size) {
  return getModernImages(buf).find(function (image) {
    return resources[image[0]].size === size
  })
}
...
module.exports.getModernImageForSize = getModernImageForSize
